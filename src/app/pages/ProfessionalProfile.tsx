    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          ...
          sender: "professional",
          text: "Certo! Vou verificar minha agenda e te retorno em breve.",
          time: new Date().toLocaleTimeString("pt-BR", {
            hour: "2-digit",
            minute: "2-digit",
          }),
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "20/02/2026",
      text: "Excelente profissional! Chegou no horário, resolveu tudo rapidinho. Super recomendo!",
    },
    {
      id: 2,
      user: "Pedro L.",
      rating: 5,
      date: "15/02/2026",
      text: "Ótimo serviço, bem caprichoso e preço justo. Já agendei a próxima visita.",
    },
    {
      id: 3,
      user: "Carla M.",
      rating: 4,
      date: "10/02/2026",
      text: "Bom trabalho! Resolveu o problema da torneira rapidamente.",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">{pro.description}</p>
                  ...
                  >
                    <div className="flex items-center justify-between mb-1.5">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center text-xs text-blue-600" style={{ fontWeight: 600 }}>
                          {r.user[0]}
                        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 sticky top-32">
              <div className="flex items-baseline gap-1 mb-1">
                <span className="text-blue-600" style={{ fontWeight: 700, fontSize: "1.75rem" }}>
                  R${pro.price}
                </span>
              ...
              <>
                ...
                <div className="p-5">
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      rows={3}
                      placeholder="Ex: Consertar torneira na cozinha, instalar 2 tomadas..."
